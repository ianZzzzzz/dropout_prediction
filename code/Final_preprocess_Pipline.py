...
raw_dataset_path =    {    
    ...
    ,'test_label'  : 'raw_data_file\\test_truth_T.csv'
...
dict_ori_and_predict_label_test = assemble_predicted_and_predict_label(
    list_label = list_label_test,
    list_e_id = list_e_id_test,
    predict_label = predict_label_int)
...
def analy_predict_result(
    ...
    if binning ==True:# for continues values feature
        ...
        '''  plt.hist(np_feat_cate)
        plt.title(feature,' bins.')
        plt.show()'''
