...
dtrain = xgb.DMatrix(df_train_data, df_train_label)
dtest = xgb.DMatrix(df_test_data,df_test_label)
...
accuracy = accuracy_score(y_pred,df_test_label.values)

precision = precision_score(y_pred,df_test_label.values)
