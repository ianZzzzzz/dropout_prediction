...
u_info_path = 'raw_data_file\\user_info_t.csv'
...
# dict_c_info = json.load( open('dict_course_info.json','r'))
# dict_u_info = json.load( open('dict_u_info.json','r'))
...
# info,static_interval_dict,enroll_scene_dict
