...
def extract_feature(name:str,dict_log):
    ...
    dict_info = assemble_info_data(name = name)
    feature_dict = caculate_time_interval(dict_log)
    return feature_dict
...
dict_train_log = preprocess(name='train', path = log_path['train'])
dict_train_feature = extract_feature(
    name = 'train',
    dict_log = dict_train_info
    )
